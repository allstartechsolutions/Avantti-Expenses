...
{
    /**
     * Register Equipment so an admin can switch it off from System Settings
     * like every other non-core module. docs/equipment-module.md
     */
    public function up(): void
    {
        ...
        $module = config('modules.equipment');
    ...
    {
        DB::table('module_access')->where('module_key', 'equipment')->delete();
    }
};
