...
class PermissionSeeder extends Seeder
{
    ...
    protected const MANAGER_ONLY_ABILITIES = [
        ...
        // --- Workers (2026-09-07). Saying two employee rows are one human is
        //     a judgement signed with a reason, and it changes what a report
        //     of "every contract this worker was on" returns. A manager
        //     decides; an employee sees the result.
        'workers.link',
