...
and three closing phases F0–F2. **All 36 areas and 186 abilities are enforced.** (30 and 147
...
Three flat roles (`is_admin` / `is_manager`) became a catalogue of **36 areas and 186
...
```
Catalogue: 36 areas, 186 abilities. Swept: 36/36. (`company-expenses` and `equipment` joined on 2026-09-16 — docs/company-expenses.md, docs/equipment-module.md.)
