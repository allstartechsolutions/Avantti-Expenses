...
and three closing phases F0–F2. **All 35 areas and 180 abilities are enforced.** (30 and 147
...
Three flat roles (`is_admin` / `is_manager`) became a catalogue of **35 areas and 180
...
```
Catalogue: 35 areas, 180 abilities. Swept: 35/35. (`company-expenses` joined on 2026-09-16 — docs/company-expenses.md.)
