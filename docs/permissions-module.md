...
and three closing phases F0–F2. **All 34 areas and 174 abilities are enforced.** (30 and 147
...
Three flat roles (`is_admin` / `is_manager`) became a catalogue of **34 areas and 174
...
```
Catalogue: 34 areas, 174 abilities. Swept: 34/34.
