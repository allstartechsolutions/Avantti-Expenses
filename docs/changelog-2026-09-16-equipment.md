...
| `app/Livewire/Equipment/{EquipmentIndex,EquipmentCreate,EquipmentEdit,EquipmentShow,MaintenanceIndex}.php`, `app/Livewire/Concerns/ManagesEquipmentForm.php`, `resources/views/livewire/equipment/**` | **New.** The screens; the equipment page's seven tabs are partials |
