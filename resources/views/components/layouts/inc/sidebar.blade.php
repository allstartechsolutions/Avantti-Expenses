    ...
    <nav class="flex-1 px-4 py-4 overflow-y-auto" @scroll="$dispatch('rail-reposition')">
        ...
        <div class="mb-6">
            ...
            <div class="mb-1" x-data="railFlyout"
                 ...
                 @rail-reposition.window="open && place()"
                 x-effect="rail || hide()">
                <button @click="rail ? toggle() : toggleSubmenu('company')"
                ...
                <!-- Company Submenu -->
                <div x-show="rail ? open : activeSubmenu === 'company'" x-cloak x-ref="panel"
                    ...
                    <a href="{{ route('company.info') }}"
                       class="flex items-center px-3 py-2 text-sm {{ request()->routeIs('company.info') ? 'text-[#3F5189] dark:text-[#4A5A96] font-medium' : 'text-slate-600 dark:text-slate-300' }} rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
            ...
            <div class="mb-1" x-data="railFlyout"
                 ...
                 @rail-reposition.window="open && place()"
                 x-effect="rail || hide()">
                <button @click="rail ? toggle() : toggleSubmenu('projects')"
                ...
                <!-- Projects Submenu -->
                <div x-show="rail ? open : activeSubmenu === 'projects'" x-cloak x-ref="panel"
                     x-transition:enter="transition ease-out duration-200"
                     x-transition:enter-start="opacity-0 transform scale-95"
                     x-transition:enter-end="opacity-100 transform scale-100"
                     x-transition:leave="transition ease-in duration-150"
            ...
            <div class="mb-1" x-data="railFlyout"
                 ...
                 @rail-reposition.window="open && place()"
                 x-effect="rail || hide()">
                <button @click="rail ? toggle() : toggleSubmenu('catalog')"
                ...
                <!-- Catalog Submenu -->
                <div x-show="rail ? open : activeSubmenu === 'catalog'" x-cloak x-ref="panel"
                     x-transition:enter="transition ease-out duration-200"
                     x-transition:enter-start="opacity-0 transform scale-95"
                     x-transition:enter-end="opacity-100 transform scale-100"
                     x-transition:leave="transition ease-in duration-150"
            ...
            <div class="mb-1" x-data="railFlyout"
                 ...
                 @rail-reposition.window="open && place()"
                 x-effect="rail || hide()">
                <button @click="rail ? toggle() : toggleSubmenu('reports')"
                ...
                <!-- Reports Submenu -->
                <div x-show="rail ? open : activeSubmenu === 'reports'" x-cloak x-ref="panel"
                     x-transition:enter="transition ease-out duration-200"
                     x-transition:enter-start="opacity-0 transform scale-95"
                     x-transition:enter-end="opacity-100 transform scale-100"
                     x-transition:leave="transition ease-in duration-150"
                    ...
                    <a href="{{ route('reports.accounts-payable') }}"
                       class="flex items-center px-3 py-2 text-sm {{ request()->routeIs('reports.accounts-payable') ? 'text-[#3F5189] dark:text-[#4A5A96] font-medium' : 'text-slate-600 dark:text-slate-300' }} rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        {{ __('Accounts Payable') }}
                    </a>
                    <a href="{{ route('reports.company-financials') }}"
                       class="flex items-center px-3 py-2 text-sm {{ request()->routeIs('reports.company-financials') ? 'text-[#3F5189] dark:text-[#4A5A96] font-medium' : 'text-slate-600 dark:text-slate-300' }} rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        {{ __('Company Financials') }}
                    </a>
                    ...
                    <a href="{{ route('reports.payment-schedule') }}"
                       class="flex items-center px-3 py-2 text-sm {{ request()->routeIs('reports.payment-schedule') ? 'text-[#3F5189] dark:text-[#4A5A96] font-medium' : 'text-slate-600 dark:text-slate-300' }} rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        {{ __('Payment Schedule') }}
                    </a>
                    <a href="{{ route('reports.payment-details') }}"
                       class="flex items-center px-3 py-2 text-sm {{ request()->routeIs('reports.payment-details') ? 'text-[#3F5189] dark:text-[#4A5A96] font-medium' : 'text-slate-600 dark:text-slate-300' }} rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
