<aside class="fixed top-0 left-0 z-40 h-screen transition-all duration-300 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 shadow-sm"
    ...
    <nav class="flex-1 px-4 py-4 overflow-y-auto">
        ...
        <div class="mb-6">
            ...
            <!-- System Settings -->
            <a href="{{ route('system-settings.index') }}" class="flex items-center px-2.5 py-2.5 mb-1 text-sm font-medium {{ request()->routeIs('system-settings.*') ? 'text-white bg-gradient-to-r from-[#3F5189] to-[#4A5A96]' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700' }} rounded-lg group">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span x-show="!sidebarCollapsed || sidebarOpen" x-cloak>Settings</span>
            </a>
        </div>
    </nav>
