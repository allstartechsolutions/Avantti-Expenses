<x-jobsite-layout :jobSite="$jobSite" active="documents" title="{{ __('Documents') }}">
    <div class="space-y-6">
        @if(session('error'))
        ...
        @include('livewire.documents.partials.toolbar', ['showLocation' => false, 'jobSites' => null])
        @include('livewire.documents.partials.summary')
        @include('livewire.documents.partials.browser')
    </div>

    @include('livewire.documents.partials.upload-modal', ['jobSites' => null])
    ...
    @include('livewire.documents.partials.edit-modal', ['jobSites' => null])
</x-jobsite-layout>
