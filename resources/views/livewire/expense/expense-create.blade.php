<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Add Expense</h1>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
            <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Expense Details</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Basic information about this expense</p>
            </div>
            ...
            <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Add the items for this expense</p>
                    </div>
            ...
            <div class="p-6">
                ...
                @else
                    <div class="text-center py-12 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Add at least one item to this expense.</p>
                        <div class="mt-4">
                            <x-ui.button type="button" variant="primary" icon="plus" wire:click="openAddItemModal">
                                Add Item
                            </x-ui.button>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
            <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Payment method and schedule</p>
            </div>
            <div class="p-6 space-y-6">
                ...
                @if(!$expense_has_installments)
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        @else
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Payment Due Date <span class="text-red-500">*</span></label>
