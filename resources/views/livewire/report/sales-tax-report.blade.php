        ...
        <div class="p-6 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <x-ui.date-input id="fromDate" wire:model.live="fromDate" class="block w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#3F5189] focus:border-[#3F5189]" />
                </div>
                <div>
                    <label for="toDate" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{{ __('To') }}</label>
                    <x-ui.date-input id="toDate" wire:model.live="toDate" class="block w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#3F5189] focus:border-[#3F5189]" />
                </div>
                @if($basis === 'accrual')
                    <div>
                ...
                <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                    ...
                    <tbody class="bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700">
                        @forelse($breakdown as $payment)
                            <tr>
                                <td class="px-6 py-3 text-sm text-slate-900 dark:text-white">{{ $payment->payment_date->appDate() }}</td>
                    ...
                    <tbody class="bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700">
                        @forelse($breakdown as $invoice)
                            <tr>
                                ...
                                <td class="px-6 py-3 text-sm text-slate-900 dark:text-white">{{ $invoice->invoice_date->appDate() }}</td>
