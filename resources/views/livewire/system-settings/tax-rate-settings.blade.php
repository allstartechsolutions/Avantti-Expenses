<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-lg font-semibold text-slate-900 dark:text-white">{{ __('Tax Rates') }}</h2>
        <x-ui.button
            variant="primary"
            wire:click="create"
            icon="plus">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-slate-900 dark:text-white">{{ __('No tax rates yet') }}</h3>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">{{ __('Get started by adding a tax rate.') }}</p>
                <div class="mt-6">
                    <x-ui.button
                        variant="primary"
                        wire:click="create"
