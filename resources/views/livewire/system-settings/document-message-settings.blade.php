<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-lg font-semibold text-slate-900 dark:text-white">{{ __('Messages') }}</h2>
        <x-ui.button
            variant="primary"
            wire:click="create"
            icon="plus">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-slate-900 dark:text-white">{{ __('No messages yet') }}</h3>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">{{ __('Get started by adding a message for invoices or estimates.') }}</p>
                <div class="mt-6">
                    <x-ui.button
                        variant="primary"
                        wire:click="create"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="{{ __('e.g., Standard Payment Terms') }}">
                            @error('title')
                        ...
                        <div>
                            ...
                            <select
                                ...
                                <option value="estimate">{{ __('Estimate') }}</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                                {{ __('Message Body') }} <span class="text-red-500">*</span>
                            </label>
                            <x-ui.tinymce-editor
                                wire-model="body"
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_default" class="ml-2 block text-sm text-slate-700 dark:text-slate-300">
                                {{ __('Set as default message for this type') }}
                            </label>
                        </div>
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50">
                                        <td class="px-4 py-2 whitespace-nowrap">
                                            ...
                                            @elseif($entry['action'] === 'deleted')
                                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-300">{{ __('Deleted') }}</span>
                                            @endif
                                        </td>
