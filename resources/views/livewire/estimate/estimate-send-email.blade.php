<div>
    <x-ui.modal name="send-email-modal" maxWidth="2xl">
        <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Email Estimate to Client</h3>
        </div>
                ...
                @if($estimate->isDraft())
                    <div class="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                        <p class="text-xs text-blue-700 dark:text-blue-300">
                            This estimate is currently a <strong>draft</strong>. Sending it will automatically change the status to <strong>Sent</strong>.
                        </p>
                    </div>
                @endif
            </div>
