<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Create Estimate</h1>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Create a new estimate for a client</p>
            </div>
            <div>
    ...
    <div class="space-y-8">
            ...
            <div class="p-6 space-y-4">
                ...
                @if($selectedMessageId || $message_body)
                    <div>
                        ...
                        <x-ui.tinymce-editor wireModel="message_body" id="estimate-message-body" :height="200" modalName="estimate-create" />
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="flex items-center justify-end space-x-4">
            <x-ui.button type="button" variant="secondary" href="{{ route('estimates.index') }}">
                Cancel
            </x-ui.button>
