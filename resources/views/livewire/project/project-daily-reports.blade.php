                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            {{-- Only an unlocked report: once it is signed off it is
                                                 the record of that day and stays. --}}
                                            @if($this->canDelete($report))
                                                <button type="button"
                                                    wire:click="deleteDailyReport({{ $report->id }})"
                                                    wire:confirm="{{ __('Delete this daily report? Its tasks, manpower, weather and photographs go with it. This cannot be undone.') }}"
