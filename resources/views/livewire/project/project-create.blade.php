                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        @else
                            ...
                            <div class="rounded-md border border-dashed border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/40 p-3 text-sm text-slate-600 dark:text-slate-400">
                                {{ __('Calculated from job sites you add after creating the project.') }}
                            </div>
                        @endif
                    </div>
