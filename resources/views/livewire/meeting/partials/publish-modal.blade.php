    ...
    <div class="p-6">
        ...
        @else
            ...
            <div class="mt-4">
                ...
                <x-ui.date-input wire:model="nextMeetingDate" class="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3F5189] bg-white dark:bg-slate-700 text-slate-900 dark:text-white" />
            </div>
        @endif
