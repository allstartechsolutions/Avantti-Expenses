<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">{{ __('Add Subcontractor') }}</h1>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">{{ __('Add a new subcontractor to the system') }}</p>
            </div>
            <div>
                <x-ui.button
                    variant="secondary"
    ...
    <form wire:submit="createSubcontractor" class="space-y-8">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
            <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">{{ __('Subcontractor company details') }}</p>
            </div>
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    @include('livewire.shared.vendor-duplicate-matches', [
                        ...
                        'flagKey' => 'is_subcontractor',
                        'flagAction' => 'markAsSubcontractor',
                        'alreadyLabel' => __('Already a subcontractor'),
                        'confirmText' => __('Flag this existing company as a subcontractor instead of creating a new record?'),
                    ])
                </div>
        ...
        <div class="flex items-center justify-end space-x-4 py-6">
            ...
            <x-ui.button
                ...
                <span wire:loading.remove>{{ __('Create Subcontractor') }}</span>
