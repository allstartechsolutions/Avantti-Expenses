<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">{{ __('Edit Subcontractor') }}</h1>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">{{ __('Update subcontractor information') }}</p>
            </div>
            <div>
                <x-ui.button
                    variant="secondary"
    ...
    <!-- Edit Form -->
    <form wire:submit="updateSubcontractor" class="space-y-8">
        ...
        <div class="flex items-center justify-end space-x-4 py-6">
            ...
            <x-ui.button
                ...
                <span wire:loading.remove>{{ __('Update Subcontractor') }}</span>
