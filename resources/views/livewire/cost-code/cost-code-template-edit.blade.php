<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">{{ __('Edit Template') }}</h1>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">{{ __('Update template details') }}</p>
            </div>
            <x-ui.button
                variant="secondary"
                ...
                <div>
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span class="ms-3 text-sm font-medium text-slate-700 dark:text-slate-300">
                            {{ $is_default ? __('This is the default template') : __('Not default') }}
                        </span>
                    </label>
