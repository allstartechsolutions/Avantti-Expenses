    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage your account information and password</p>
            </div>
            <div>
                <x-ui.button
                    variant="secondary"
        ...
        <form wire:submit="updateProfile">
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
                <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Update your name, email address and phone number</p>
                </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div x-show="newPassword.length > 0" x-transition class="rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                        <p class="text-sm font-medium text-slate-700 dark:text-slate-300 mb-3">Password requirements:</p>
                        <ul class="space-y-2">
