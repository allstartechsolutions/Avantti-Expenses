...
<x-email-shell :heading="__('Requisition')">
    ...
    <p style="margin: 0 0 18px; font-size: 14px; line-height: 1.6; color: #555;">
        {{ trans_choice(
            'This requisition was submitted :count day ago and is still waiting for a decision.|This requisition was submitted :count days ago and is still waiting for a decision.',
            $daysWaiting,
            ['count' => $daysWaiting],
        ) }}
    </p>
    ...
    <p style="margin: 0 0 18px; font-size: 13px; color: #777;">
        {{ __('Nothing can be bought against it until it is approved or rejected. Rejecting it with a reason is a better answer than leaving it.') }}
    </p>
