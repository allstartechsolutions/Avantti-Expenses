    ...
    <table style="width: 100%; border: none; margin-bottom: 15px; border-bottom: 2px solid #3F5189; padding-bottom: 10px;">
        <tr>
            ...
            <td style="width: 50%; vertical-align: top; text-align: right; border: none; padding: 0;">
                <div style="font-size: 18pt; font-weight: bold; color: #3F5189;">INVOICE</div>
        ...
        <tr>
            ...
            <td style="width: 50%; vertical-align: top; border: none; padding: 0;">
                <table style="width: 100%; border: none;">
                    <tr>
                        <td style="border: none; padding: 2px 5px; font-size: 8pt; font-weight: bold; color: #555; text-align: right;">Invoice Date:</td>
